...
Since 1.33.0 that ritual is itself a test: `tests/test_mutantes.py` breaks twenty-five real guards,
...
is also why the harness above exists: fifty-one tests, twenty-five mutants and a full run on
