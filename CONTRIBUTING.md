...
Since 1.33.0 that ritual is itself a test: `tests/test_mutantes.py` breaks thirty-two real guards,
...
is also why the harness above exists: fifty-two tests, thirty-two mutants and a full run on
