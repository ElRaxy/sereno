...
Since 1.33.0 that ritual is itself a test: `tests/test_mutantes.py` breaks one hundred and twenty-six real guards,
...
is also why the harness above exists: sixty-seven tests, one hundred and twenty-six mutants and a full run on
