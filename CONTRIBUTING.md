...
Since 1.33.0 that ritual is itself a test: `tests/test_mutantes.py` breaks one hundred and thirty-three real guards,
...
is also why the harness above exists: sixty-nine tests, one hundred and thirty-three mutants and a full run on
