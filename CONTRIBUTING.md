...
Since 1.33.0 that ritual is itself a test: `tests/test_mutantes.py` breaks one hundred and fifty-four real guards,
...
is also why the harness above exists: seventy-three tests, one hundred and fifty-four mutants and a full run on
