...
Since 1.33.0 that ritual is itself a test: `tests/test_mutantes.py` breaks twenty-one real guards,
...
is also why the harness above exists: forty-eight tests, twenty-one mutants and a full run on
