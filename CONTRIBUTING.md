...
Since 1.33.0 that ritual is itself a test: `tests/test_mutantes.py` breaks one hundred and sixty-one real guards,
...
is also why the harness above exists: seventy-five tests, one hundred and sixty-one mutants and a full run on
