...
Since 1.33.0 that ritual is itself a test: `tests/test_mutantes.py` breaks one hundred and forty real guards,
...
is also why the harness above exists: seventy tests, one hundred and forty mutants and a full run on
