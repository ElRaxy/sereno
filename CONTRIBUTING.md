...
Since 1.33.0 that ritual is itself a test: `tests/test_mutantes.py` breaks one hundred and twenty real guards,
...
is also why the harness above exists: sixty-six tests, one hundred and twenty mutants and a full run on
