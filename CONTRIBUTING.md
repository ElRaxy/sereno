...
Since 1.33.0 that ritual is itself a test: `tests/test_mutantes.py` breaks eighty-nine real guards,
...
is also why the harness above exists: fifty-eight tests, eighty-nine mutants and a full run on
