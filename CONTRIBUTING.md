...
Since 1.33.0 that ritual is itself a test: `tests/test_mutantes.py` breaks one hundred and ten real guards,
...
is also why the harness above exists: sixty-three tests, one hundred and ten mutants and a full run on
