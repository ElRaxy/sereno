...
Since 1.33.0 that ritual is itself a test: `tests/test_mutantes.py` breaks sixty-seven real guards,
...
is also why the harness above exists: fifty-six tests, sixty-seven mutants and a full run on
