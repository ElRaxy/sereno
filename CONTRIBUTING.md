...
Since 1.33.0 that ritual is itself a test: `tests/test_mutantes.py` breaks one hundred and thirty-one real guards,
...
is also why the harness above exists: sixty-eight tests, one hundred and thirty-one mutants and a full run on
