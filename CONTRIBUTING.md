...
Since 1.33.0 that ritual is itself a test: `tests/test_mutantes.py` breaks one hundred real guards,
...
is also why the harness above exists: fifty-nine tests, one hundred mutants and a full run on
