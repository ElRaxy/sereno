...
Since 1.33.0 that ritual is itself a test: `tests/test_mutantes.py` breaks one hundred and nine real guards,
...
is also why the harness above exists: sixty-two tests, one hundred and nine mutants and a full run on
