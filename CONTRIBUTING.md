...
Since 1.33.0 that ritual is itself a test: `tests/test_mutantes.py` breaks forty-one real guards,
...
is also why the harness above exists: fifty-three tests, forty-one mutants and a full run on
