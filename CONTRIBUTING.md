...
Since 1.33.0 that ritual is itself a test: `tests/test_mutantes.py` breaks one hundred and seventy-six real guards,
...
is also why the harness above exists: seventy-eight tests, one hundred and seventy-six mutants and a full run on
