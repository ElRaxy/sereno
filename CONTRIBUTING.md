...
Since 1.33.0 that ritual is itself a test: `tests/test_mutantes.py` breaks one hundred and thirty-nine real guards,
...
is also why the harness above exists: seventy tests, one hundred and thirty-nine mutants and a full run on
