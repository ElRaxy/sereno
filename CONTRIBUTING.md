...
Since 1.33.0 that ritual is itself a test: `tests/test_mutantes.py` breaks one hundred and seventeen real guards,
...
is also why the harness above exists: sixty-five tests, one hundred and seventeen mutants and a full run on
