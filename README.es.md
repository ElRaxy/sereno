...
la carpeta entera, imprime una línea por fichero y termina con la cuenta. Hoy son sesenta y dos,
...
- **Un test que no has visto fallar no vale.** Rompe el código a propósito, míralo ponerse rojo y
  ...
  `tests/test_mutantes.py` rompe ciento nueve guardas de verdad, una a una, sobre una copia del
  árbol, y
