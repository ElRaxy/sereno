...
Every row below exists somewhere else. The point isn't that sereno invented any of them — it's
that no other single tool has all of them, and none in this form.
